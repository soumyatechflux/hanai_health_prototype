                ...
                <div id="wrapper">
                    ...
                    <div id="sidebar-wrapper" className='position-fixed'>
                        <ul className="sidebar-nav nav-pills nav-stacked" id="menu" >
                            ...
                            <li className={selectedPath === '/orders' ? 'Selectedddddd' : ''}>
                                <a onClick={() => handleNavigation('/orders')} style={{ color: selectedPath === '/orders' ? 'red' : '' }}>
                                    <span className={`fa-stack fa-lg pull-left side-icon`} style={{ color: selectedPath === '/orders' ? 'red' : '' }}>
                                    <BiClipboard className='icon' style={{ color: selectedPath === '/orders' ? 'red' : '', width:'100%' }}/>
                                    </span>
                                </a>
                            </li>
